...
*Defterime çizdiğim grafiğin eğimini 21,052 buldum.
...
* Defterime çizdiğim grafiğin eğim formülünü 21x+0,39 buldum.

c) Elle çizdiğiniz grafik orijinden geçmiyor.  *x=0* iken *y=0* değil. *x=0* iken *y* nedir? Sizce neden orjinden geçmiyor?
**Cevap:**

* Uzanım değerleri tam olarak doğru ölçülemediği için grafik orijinden geçmiyor.
...
!(https://docs.google.com/spreadsheets/d/1ghwilIBWmgg7w8rIYWNWrjJgyc_v1Ve6eAng4FfVqw8/edit?usp=sharing)
